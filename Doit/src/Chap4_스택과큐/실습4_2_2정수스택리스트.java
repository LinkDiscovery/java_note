...
class IntStack4 {
	...
	private int ptr; // 스택 포인터 top이라고 생각할 것 변수 이름도 top이 더 좋음

//--- 실행시 예외: 스택이 비어있음 ---//
	//내가 만드는 것 , 내장 클래스를 상속 받아서 
	public class EmptyIntStackException extends RuntimeException {//RuntimeException위에는 exception이 있다. RuntimeException > 아마 추상클래스 일것
																  /**
		 * 
		 */
		private static final long serialVersionUID = 1L;

		//자바 내장 클래스 runtimeexception
