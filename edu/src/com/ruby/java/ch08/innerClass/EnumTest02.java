...
//    0         1          2           3         4       > 정수화 하는 값 
	...
	Mandarin(int p) { // 생성자 인데 생성자가 아니다 유의!!!!!!!, 
//		                 언제 어떻게 호출해야하는지 공부를 해야 깊이있게 된다.
		price = p;
	...
	static Mandarin MandarinAt(int idx) { // 만다린의 static 메소드
...
public class EnumTest02 {
	...
	public static void main(String[] args) {
		...
		//Mandarin m2 = new Mandarin(100);//생성자를 호출할 수 없다 - 주의점 // 생성자를 만들지 못한다.위에 생성자 같이 생긴게 있는데 
																		//enum은 생성자와 다르다. 자료구조할 때 많이 사용
		//*
		...
		Mandarin ma2 = Mandarin.valueOf("레드향"); // valueOf 클래스의 static 메소드
//		Mandarin ma2 = new Mandarin(100); - 오류 
