...
public class Test05_LinkedList {
	...
	public static void main(String[] args) {
		...
		System.out.println("7 : " + list.peek()); //peek
		...
		List<String> list2 = Arrays.asList("북경", "상해");//배열을 리스트로 만들어주는 것 , 리스트를 배열로 만들어주는 것
		list.addAll(list2);
	...
	static void print(int n, List<String> list) {
		System.out.println(n + " : " + list);//list.toString() 호출 // iterator의 오버라이딩된 toString(); 출력
	}
}
